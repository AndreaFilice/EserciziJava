...
public class Oracolo {
    ...
    public void parla() {
        ...
        System.out.println("Risponderò a qualsiasi domanda che digiterai su una riga.");
    ...
    private void rispondi() {
        System.out.println("Qual è la tua domanda?");
        Scanner tastiera = new Scanner(System.in);
    ...
    private void cercaSuggerimento() {
        ...
        System.out.print("Scrivimi una riga di aiuto: ");
        Scanner tastiera = new Scanner(System.in);
