        ...
        while (true){
            ...
            switch (scelta){
                ...
                case 1:
                    ...
                    System.out.println("Inserisci la data di inizio del progetto: ");
                    String dataInizio = t.nextLine();
                    System.out.println("Inserisci il budget del progetto: ");
                    double budget = t.nextDouble();

                    Progetto newPrj = new Progetto(newDipendente, nomeProgetto, dataInizio, budget);
